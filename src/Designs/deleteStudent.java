...
public class deleteStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Remove a Student from University");
        ...
        deleteB.setText("Delete Student");
        ...
        jLabel5.setText("Kindly enter Student's ID to whom you want to Remove ");
    ...
    private void deleteBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBActionPerformed
        ...
        DAO_EducationImpl d = new DAO_EducationImpl();
            ...
            try {
                d.deleteStoredProcedureIntoStudent(Integer.parseInt(studentidTF.getText()));
    ...
    private void searchBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBActionPerformed
        ...
        for (int i = 0; i < University.getStudents().size(); i++) {
            if(University.getStudent(i).getStudentId().equals(key)){
                infoTA.setText("Teachers ID: "+University.getStudent(i).getStudentId()+"\n"
                    +"Name : "+University.getStudent(i).getName()+"\n"+
                    "Address: "+University.getStudent(i).getAddress()+"\n"+
                    "Phone no: "+University.getStudent(i).getPhone_no()+"\n"+
                    "Department : "+University.getStudent(i).getStudentEmail());
                return;
            }
        }
