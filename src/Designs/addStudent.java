...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Set information to add Student in University ");
        ...
        addStudentB.setBackground(new java.awt.Color(255, 153, 153));
        addStudentB.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void addStudentBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addStudentBActionPerformed
        ...
        if(!nameTF.getText().isEmpty()&&!addressTF.getText().isEmpty()&&
            !phonenoTF.getText().isEmpty()&&!studentidTF.getText().isEmpty()&&
